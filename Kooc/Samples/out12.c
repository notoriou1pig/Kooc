...
#include <stdio.h>
#include <setjmp.h>
#ifndef __IN12_FILE__
#define __IN12_FILE__
#include "in12.h"
#endif /* __IN12_FILE__ */
    ...
    if (!(setjmp(kooc_global_env)))
        {
            ...
            ((Toto_table *)to->func_table)->F__M_Toto_i_funcb_i_i_i_F((void *)to, to->V__M_Toto_i_i_V, to->V__M_Toto_i_i_V, to->V__M_Toto_i_i_V);
            return (0);
        }
    else
        {
