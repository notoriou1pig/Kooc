#if defined(__IN17_MODULE_TOTO__) || defined(__IN17_FILE__)
# ifndef __IN17_MODULE_TOTO_INC__
#  define __IN17_MODULE_TOTO_INC__
...
# endif
#endif
#if defined(__MODULE_TEST__) || defined(__IN17_FILE__)
